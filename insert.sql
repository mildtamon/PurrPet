...
-- insert products
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p01','SmartHeart Roast Beef Flavor',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p02','SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p03','SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p04','SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p05','SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p06','SmartHeart Chicken & Liver Flavor',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p07','SmartHeart Beef Steak Flavor',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p10','Me-O Tuna in Jelly for Senior Cat 7+',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p11','TetraMin Nutritionally Balanced Tropical Flake Food for Tropical Fish, 7.06 oz',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p12','Cat Tree with Cat Condo and Big Hammock，Grey',
...
INSERT INTO products(prod_id, prod_name, prod_img_URL, prod_brand, prod_range, prod_desc, prod_size, prod_type, animal_type, prod_barcode, price) VALUES
                    ('p13','Catstages Tower of Tracks Interactive 3-Tier Cat Toy',
...
INSERT INTO orders(trans_id, prod_id, trans_date, exp_date, amount, cost) VALUES
                    ('t00002','p01','2024-01-01 13:45:30','2026-04-23',50,35);
...
INSERT INTO distributions(dist_id, prod_id, branch_id, trans_date, trans_id, amount) VALUES
                    ('d00002','p01','s02','2023-12-21 11:20:30','t00001',30);
