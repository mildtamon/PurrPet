...
call updateProduct('SmartHeart Roast Beef Flavor','https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg','SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
                            'Immune System : Vitamin E and Selenium for strong immune system. ' ||
                            'Healthy Digestion : Highly digestible ingredients for improved digestion and stool quality. ' ||
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.','500 g','food','dog','012345678912',45);
call orderProduct('t2','bit.ly/3sdf2ss','SmartHeart Roast Beef Flavor','1.5 kg', '2025-2-12',100, 89,'storage #1 shelf #1' );
call updateproduct('SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '1.5 kg','food','dog','012345672313',139);
call orderproduct('t3','bit.ly/3idl','SmartHeart Roast Beef Flavor','3.0 kg','2025-2-8',100,159,'storage #1 shelf #1');
call updateproduct('SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '3.0 kg','food','dog','012345679414',240);
call orderproduct('t4','bit.ly/ad34c','SmartHeart Roast Beef Flavor','10.0 kg','2025-4-23',100,499,'storage #1 shelf #2');
call updateproduct('SmartHeart Roast Beef Flavor',
                            'https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '10.0 kg','food','dog','012345324415',755);
call orderproduct('t5','bit.ly/asd4c','SmartHeart Roast Beef Flavor','20.0 kg','2025-3-23',100,899,'storage #1 shelf #2');
call updateproduct('SmartHeart Roast Beef Flavor','https://th-test-11.slatic.net/p/fbad54c19ba78795d85b5a1fc7d9a1fa.jpg',
                            'SmartHeart','Adult, All Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
                            'Immune System : Vitamin E and Selenium for strong immune system. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '20.0 kg','food','dog','012345392416',1140);
call orderproduct('t6','bit.ly/ipd03','SmartHeart Chicken & Liver Flavor','450 g','2025-1-23',100,25,'storage #1 shelf #1');
call updateproduct('SmartHeart Chicken & Liver Flavor',
                            'https://inwfile.com/s-dl/w1m0fl.png',
                            'SmartHeart','All Toy, Small Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '450 g','food','dog','012373057819',55);
call orderproduct('t7','bit.ly/wsxm4','SmartHeart Beef Steak Flavor','1.3 kg','2025-1-2',100,95,'storage #1 shelf #1');
call updateproduct('SmartHeart Beef Steak Flavor',
                            'https://www.perfectcompanion.com/uploads/stock/64.png',
                            'SmartHeart','Adult, All Toy, Small Breeds','Enhanced Brain Function : DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function. ' ||
                            'Healthy Heart : Omega3 fatty acids from fish oil for a healthy heart. ' ||
                            'Healthy Skin and Coat : Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat. ' ||
                            ...
                            'Strong Bones & Teeth : Calcium and Phosphorus for strong bones and teeth.',
                    '1.3 kg','food','dog','012373077820',150);
call orderproduct('t8','bit.ly/324ssx','Me-O Ocean Fish','450 g','2025-1-1',100,47,'storage #1 shelf #3');
call updateproduct('Me-O Ocean Fish',
                            'https://tailybuddy.com/products/232/960f04b773fd23f0354bd48507b8992e_tn.jpg',
                            'Me-O','Adult, All Breeds','Complete and balanced nutrition for cats. ' ||
                            'Taurine is an amino acid that is essential for the proper functioning of the eyes and to improve the cat''s eyesight. ' ||
                            'Vitamin C boots cat''s immune system and helps reduce the detrimental effects of stress on your cat''s health. ' ||
                            ...
                            'Lowsodium formula helps decrease the risks of high blood pressure, kidney and heart disease in cats',
                    '450 g','food','cat','098764283945',68);
call orderproduct('t9','bit.ly/3dxxp','Me-O Kitten Ocean Fish','400 g','2026-2-1',100,47,'storage #1 shelf #3');
call updateproduct('Me-O Kitten Ocean Fish',
                            'https://www.perfectcompanion.com/uploads/stock/154.png',
                            'Me-O','Kitten, All Breeds','Complete and balanced nutrition for cats. ' ||
                            'Taurine is an amino acid that is essential for the proper functioning of the eyes and to improve the cat''s eyesight. ' ||
                            'Vitamin C boots cat''s immune system and helps reduce the detrimental effects of stress on your cat''s health. ' ||
                            ...
                            'Lowsodium formula helps decrease the risks of high blood pressure, kidney and heart disease in cats',
                    '400 g','food','cat','098764244945',68);
call orderproduct('t10','bit.ly/3dxxp','Me-O Tuna in Jelly for Senior Cat 7+','80 g','2025-9-8',100,8,'storage #1 shelf #3');
call updateproduct('Me-O Tuna in Jelly for Senior Cat 7+',
                            'https://www.perfectcompanion.com/uploads/stock/b3182689-caa7-4a94-ad8a-1eb189a1cd9f.png',
                            'Me-O','Senior, All Breeds','Made from real meat and real fish',
                    '80 g','food','cat','098182048342',17);
call orderproduct('t11','bit.ly/3emqp','TetraMin Nutritionally Balanced Tropical Flake Food for Tropical Fish','12 g','2025-11-8',100,4,'storage #1 shelf #4');
call updateproduct('TetraMin Nutritionally Balanced Tropical Flake Food for Tropical Fish',
                            'https://m.media-amazon.com/images/I/71yHwkhzSKL._AC_UF1000,1000_QL80_.jpg',
                            'Tetra','All','TetraMin(R) Tropical Flakes have been improved with the fishkeeper''s success in mind. ' ||
                            'Our upgraded formula is nutritionally balanced to support health. ' ||
                            'TetraMin(R) Tropical Flakes continue to offer a complete diet with a clear water formula that''s easier to digest, leaving less waste in the tank.',
                    '12 g','food','fish','028382048342',30);
call orderproduct('t12','bit.ly/7snmd','Cat Tree with Cat Condo and Big Hammock，Grey','22.44"L x 13.78"W x 39.37"H',NULL,100,99,'storage #1 shelf #5');
call updateproduct('Cat Tree with Cat Condo and Big Hammock，Grey',
                            'https://m.media-amazon.com/images/I/71t2Wh-yd4L._AC_UF1000,1000_QL80_.jpg',
                            'YUNWEI','all','High quality faux fur, natural sisal posts durable for long time scratch. ' ||
                            'The hanging ball can provide cats lot of fun,it also can be replaced. ' ||
                            'The big condo can provide cats sleeping place as well as observe place.The round shape soft platform can let cats observe like a queen and look view outside of the window. ' ||
                            'The hanging bed can let cats relax and sleep.And it can be removed and washed.',
                     '22.44"L x 13.78"W x 39.37"H','house','cat','283048248342',2999);
call orderproduct('t13','bit.ly/9olk','Catstages Tower of Tracks Interactive 3-Tier Cat Toy','5.5x1x6.5"; 8.8 ounces',NULL,100,59,'storage #1 shelf #5');
call updateproduct('Catstages Tower of Tracks Interactive 3-Tier Cat Toy',
                            'https://kataidian.com/cdn/shop/products/71QqO6_ZItL._AC_SL1500.jpg?v=1704395700',
                            'Catstages','all',
                            'MENTALLY ENGAGING TRACKS TOY: This interactive cat toy is designed with 3 levels of tracks and 6 brightly colored moving balls to attract kitty’s attention! ' ||
                            'Your cat will adore batting, swatting, and pouncing the bright colored balls as they engage their natural instincts to hunt.',
                     '5.5x1x6.5"; 8.8 ounces','toy','cat','333048158342',249);
call orderproduct('t14','bit.ly/cn6','PetArmor Plus Flea and Tick Prevention for Dogs, Dog Flea and Tick Treatment, 3 Doses, Waterproof Topical, Fast Acting, Small Dogs (5-22 lbs)','3 tablets','2026-11-8',100,59,'storage #1 shelf #1');
call updateproduct('PetArmor Plus Flea and Tick Prevention for Dogs, Dog Flea and Tick Treatment, 3 Doses, Waterproof Topical, Fast Acting, Small Dogs (5-22 lbs)',
                            'https://petarmor.com/cdn/shop/products/815249012864_PetArmor_MediumDog_F_T_Topical_3ct_FRNT.png?v=1669737146',
                            'PetArmor','Small Dogs (2-10 kg)',
                            'Effective, Waterproof Flea Treatment for Dogs: PetArmor Plus is a waterproof, flea & tick topical prevention for dogs that kills fleas, flea eggs, flea larvae, ticks, and chewing lice for up to 30 days after application',
                     '3 tablets','medicine','dog','449048158342',123);
call orderproduct('t15','bit.ly/3rg','HomeoPet Feline WRM Clear, Natural Tapeworm, Whipworm, Roundworm, and Hookworm Medicine for Cats','15 ML','2026-1-8',100,59,'storage #1 shelf #3');
call updateproduct('HomeoPet Feline WRM Clear, Natural Tapeworm, Whipworm, Roundworm, and Hookworm Medicine for Cats',
                            'https://www.homeopet.com/wp-content/uploads/2018/05/Feline_WRM_Clear_sm.jpg',
                            'HomeoPet','all','WORM MEDICINE FOR CATS & KITTENS: Our WRM Clear natural pet medicine can help your cat or kitten naturally remove roundworm, tapeworm, whipworm, and hookworm. ' ||
                            'This broad-spectrum treatment is a safe ally in the fight against worm infestations.',
                     '15 ML','medicine','cat','449042345342',123);
call orderProduct('t16','bit.ly/12ssafs','Purina Pro Plan Allergen Reducing, High Protein Cat Food, LIVECLEAR Chicken and Rice Formula','3 kg','2025-3-11',100,23,'storage #2 shelf #1');
...
INSERT INTO shops(shop_name,shop_location) VALUES ('Ladkrabang warehouse',
                '11/6 Patthana Chonabot 3 Rd., Khlong Song Ton Nun, Lat Krabang, Bangkok, 10520');
INSERT INTO shops(shop_name,shop_location) VALUES ('Salaya pet shop',
                '999 Phutthamonthon 4 Rd., Salaya, Phutthamonthon, Nakhon Pathom 73170');
INSERT INTO shops(shop_name,shop_location) VALUES ('Samyan pet shop',
                '944 Rama IV Rd, Wang Mai, Pathum Wan,Bangkok 10330');

-- insert staffs
INSERT INTO staffs(staff_name, staff_citizen_id, staff_email, staff_contact, staff_bank_book, staff_address, staff_type,workplace,salary) VALUES
                    ('dummy','0123456789123','admin@gmail.com','0987654321','1234567890','123 Phutthamonthon 3 Rd., Salaya, Phutthamonthon, Nakhon Pathom 73170','admin',2,220000);
INSERT INTO staffs(staff_name, staff_citizen_id, staff_email, staff_contact, staff_bank_book, staff_address, staff_type,workplace,salary) VALUES
                    ('mild','2957393640128','mild@gmail.com','0627491623','1730593261','13/34 Building 12 V-condo, Soi Tang-sin, Salaya, Phutthamonthon, Nakhon Pathom 73170','cashier',2,15000);
INSERT INTO staffs(staff_name, staff_citizen_id, staff_email, staff_contact, staff_bank_book, staff_address, staff_type,workplace,salary) VALUES
                    ('max','205480481354','max@gmail.com','0620371294','1903739561','56/33 Salaya-One, Soi Tang-sin, Salaya, Phutthamonthon, Nakhon Pathom 73170','cashier',3,15000);
INSERT INTO staffs(staff_name, staff_citizen_id, staff_email, staff_contact, staff_bank_book, staff_address, staff_type,workplace,salary) VALUES
                    ('john','2057390135411','john@gmail.com','0620779314','1904449561','6/33 Bundit home, Soi Tang-sin, Salaya, Phutthamonthon, Nakhon Pathom 73170','warehouse staff',1,15000);

-- insert customers
INSERT INTO customers(customer_name, customer_email, customer_contact) VALUES
                        ('guest','guest@gmail.com','0000000000');
INSERT INTO customers(customer_name, customer_email, customer_contact) VALUES
                        ('alex','alex@gmail.com','0284750183');
INSERT INTO customers(customer_name, customer_email, customer_contact) VALUES
...
INSERT INTO order_status(status_name) VALUES ('rejected');
